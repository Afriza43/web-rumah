...
$tabel = query("SELECT * FROM formulir");
          ...
          <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">List Pesanan</h5>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="border-bottom-0">
                            <select name="cars" id="cars">
                              <option value="volvo">Unverified</option>
                              <option value="saab">Verified</option>
                            </select>
                          </td>
                          <td class="border-bottom-0">
                            <a href="cek_berkas.php?no_daftar=<?= $data["no_daftar"]; ?>"><button class="btn btn-primary rounded-3 fw-semibold">Cek</button></a>
                          </td>
                          <td class="border-bottom-0">
                            <a href="hapus.php?no_daftar=<?= $data["no_daftar"]; ?>"><button class="btn btn-danger rounded-3 fw-semibold">Hapus</button></a>
                          </td>
                        </tr>
                      </tbody>
                    <?php $i++;
