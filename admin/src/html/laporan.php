                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                      <tr class="text-center">
                        ...
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">Edit Laporan</h6>
                        </th>
                      </tr>
                    </thead>
                    <?php $i = 1; ?>
                    <?php foreach ($tabel as $data) : ?>
                      <tbody>
                        <tr class="text-center">
                          ...
                          <td class="border-bottom-0">
                            <a href="progress.php?id_user=<?= $data["id_user"]; ?>"><button class="btn btn-primary rounded-3 fw-semibold">Buat</button></a>
                          </td>
                          <td class="border-bottom-0">
                            <a href="edit_lap.php?id_user=<?= $data["id_user"]; ?>"><button class="btn btn-primary rounded-3 fw-semibold">Edit</button></a>
                          </td>
                        </tr>
                      </tbody>
                    <?php $i++;
