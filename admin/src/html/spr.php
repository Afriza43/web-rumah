    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">SPR</h5>
              <div class="card">
                <div class="card-body">
                  <form>
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col mb-3">
                        <label class="form-label">PPN Rumah</label>
                        <div class="input-group">
                          <span class="input-group-text">Rp</span>
                          <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
                          <span class="input-group-text">.00</span>
                    ...
                    <div class="row">
                      ...
                      <div class="col mb-3">
                        <label class="form-label">BPHTB</label>
                        <div class="input-group">
                          <span class="input-group-text">Rp</span>
                          <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
                          <span class="input-group-text">.00</span>
                    ...
                    <div class="row">
                      ...
                      <div class="col mb-3">
                        <label class="form-label">Rumah Hook</label>
                        <div class="input-group">
                          <span class="input-group-text">Rp</span>
                          <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
                          <span class="input-group-text">.00</span>
                    ...
                    <div class="row">
                      ...
                      <div class="col mb-3">
                        <label class="form-label">Biaya Proses KPR</label>
                        <div class="input-group">
                          <span class="input-group-text">Rp</span>
                          <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
                          <span class="input-group-text">.00</span>
                    ...
                    <div class="row">
                      ...
                      <div class="col mb-3">
                        <label class="form-label">Rumah Open Space</label>
                        <div class="input-group">
                          <span class="input-group-text">Rp</span>
                          <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
                          <span class="input-group-text">.00</span>
                    ...
                    <div class="row">
                      ...
                      <div class="col mb-3">
                        <label class="form-label">Biaya Kelebihan Tanah</label>
                        <div class="input-group">
                          <span class="input-group-text">Rp</span>
                          <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
                          <span class="input-group-text">.00</span>
                    ...
                    <div class="row">
                      ...
                      <div class="col mb-3">
                        <label class="form-label">PPN Kelebihan Tanah</label>
                        <div class="input-group">
                          <span class="input-group-text">Rp</span>
                          <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
                          <span class="input-group-text">.00</span>
                    ...
                    <div class="row">
                      <div class="col mb-3">
                        <label class="form-label">No. Kavling</label>
                        <input class="form-control">
                      </div>
                      <div class="col mb-3">
                    ...
                    <a href="./edit-katalog_2.php"><button type="submit" class="btn btn-danger">Next</button></a>
