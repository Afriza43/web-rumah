...
if (isset($_POST["submit"])) {
  if (insert($_POST) > 0) {
    ...
    echo "
    <script>
      alert('Tambah Katalog Berhasil');
    </script>";
    header("Location: tambah-detail.php?no_rumah=" . $new_id);
    exit();
  } else {
    echo "
    <script>
      alert('Tambah Katalog Gagal');
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Tambah Katalog</h5>
              <div class="card">
                <div class="card-body">
                  <form action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                      ...
                      <div class="mb-3">
                        ...
                        <input class="form-control" name="deskripsi" id="deskripsi" rows="3"></input>
                      </div>
                      <div class="mb-3">
                        <label for="sarana" class="form-label">Sarana Prasarana</label>
                        <input type="text" name="sarana" class="form-control" id="sarana" aria-describedby="sarana">
                      </div>
                      <div class="col">
                    ...
                    <a href="tambah-detail.php?no_daftar=<?= $data["no_rumah"] ?>'"></a><button type="submit" name="next" class="btn btn-danger">Next</button>
